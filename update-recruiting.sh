...
echo "got all recruit data into football2018done1-5.csv"
...
cat helloworld.txt ../../gaultsports-site/ncaaf/base/recruiting-base.js > ../../gaultsports-site/ncaaf/recruiting.js
