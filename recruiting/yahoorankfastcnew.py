...
def getplayerlist(driver,pagen):
    plist = []
    ap = []
    burlarr = ["https://n.rivals.com/search#?formValues=%257B%2522sport%2522:%2522Football%2522,%2522stars%2522:%257B%2522range%2522:%2522eq%2522,%2522number%2522:5%257D,%2522recruit_year%2522:2017,%2522status%2522:%255B%2522signed%2522,%2522verbal%2522%255D,%2522page_number%2522:1%257D","https://n.rivals.com/search#?formValues=%257B%2522sport%2522:%2522Football%2522,%2522stars%2522:%257B%2522range%2522:%2522eq%2522,%2522number%2522:4%257D,%2522page_number%2522:1,%2522status%2522:%255B%2522signed%2522,%2522verbal%2522%255D,%2522recruit_year%2522:2017%257D"]
    burlarr.append("https://n.rivals.com/search#?formValues=%257B%2522sport%2522:%2522Football%2522,%2522recruit_year%2522:2017,%2522stars%2522:%257B%2522range%2522:%2522eq%2522,%2522number%2522:3%257D,%2522status%2522:%255B%2522signed%2522,%2522verbal%2522%255D,%2522page_number%2522:1%257D")
    burlarr.append("https://n.rivals.com/search#?formValues=%257B%2522sport%2522:%2522Football%2522,%2522stars%2522:%257B%2522range%2522:%2522lte%2522,%2522number%2522:2%257D,%2522status%2522:%255B%2522signed%2522,%2522verbal%2522%255D,%2522recruit_year%2522:2017,%2522page_number%2522:1%257D")
    
    for nstars in range(0,4):
            b_url = "https://news.ycombinator.com/item?id=12792928"
            driver.get(b_url)
            b_url = burlarr[nstars]
            driver.get(b_url)
